...
I am a **Master of Applied Computer Science** graduate from **Concordia University** specializing in **Data Analytics and Artificial Intelligence**. I specialize in building end-to-end data solutions—from optimizing complex **SQL** queries to training **Deep Learning** models and crafting interactive **Power BI** dashboards. 

I bring over **2.5 years of technical experience** across data analyst internships and academic leadership roles, combining high-level engineering with a passion for data-driven storytelling.
...
## 🎓 Education
* **M.S. in Applied Computer Science** | Concordia University, Montreal 🇨🇦
* **Bachelor's in Computer Science** | Gujarat Technological University 🇮🇳
...
> ### "Sourcing raw data is like selecting fresh ingredients; cleaning it is the prep work; but the true art is in the cooking—turning that raw complexity into a dish of actionable insights."

![Profile Views](https://komarev.com/ghpvc/?username=Ayushhpatel04&color=brightgreen&style=flat-square&label=Profile+Views)
